...
const char* const kClassName = "com/x930073498/hook/FastHookManager";
const char* const kHookRecordClassName = "com/x930073498/hook/FastHookManager$HookRecord";

enum Version {	kAndroidL = 21,
	kAndroidLMR1,
	kAndroidM,
	kAndroidN,
	kAndroidNMR1,
